...
Файл `assets/js/nav-v2/deal-card-check-v2.js` обновлён: теперь диагностика первым пунктом показывает браузерный контекст:

- email/id пользователя из кэша браузера;
