...
- approved Navigator baseline обновлён до live `20260716063401`;
- canonical repository migration: `20260716064500`;
- canonical SQL blob: `93687e0aed8d88d604e31a730ba8c9f8c806b94e`;
- client minimization source blob reconciled до `a99c3dbe1cb97a45ccb40dad4841087602aafd80`;
- введена семантика `required_present_not_global_latest`;
- более новые repository-known migrations общего Supabase project не создают ложный Navigator drift только из-за timestamp;
- unknown remote-only migrations остаются блокирующими;
- отсутствующая approved Navigator migration остаётся блокирующей;
- Edge version/status/JWT/hash/source drift остаётся блокирующим;
- historical preview package v2 сохранён как evidence;
- в package v3 release baseline blocker перенесён из active в closed repository blockers.
...
Exact green head PR #488 прошёл:

- static checks run `30033705073`;
- migration aliases run `30033701981`;
- preview package v2 run `30033701898`;
- preview package v3 run `30033702035`;
- deployment decision package run `30033705683`;
- consultation lifecycle run `30033701966`;
- PostgreSQL harness run `30033705680`;
- canonical handoff consistency run `30033702401`.
