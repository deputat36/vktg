...
- `main`: `9352df68fb9033a8086d650b9d29d9a33f81f1f2` — squash merge PR #472.
...
- После merge PR #472 открытых Navigator PR не было.

PR #457–#472 не меняли production data/schema/indexes, Auth settings, RLS, grants или Edge.
...
### Intake, privacy, preview — PR #394–#434
...
Runtime покрывает invalid/not-found/already-used refresh stop, valid refresh retry once, Web Lock `navigator-v2-auth-refresh`, re-read session after lock, replacement-session/logout races и fallback без Web Locks.
...
- source boundary + five Auth recovery suites: `29955633485`;
- static 49/49: `29955632495`.
