-- Extend the bounded-task synthetic environment with columns required by lite DTO.
...
insert into public.nav_deal_documents_v2(
  id,deal_id,side,status,is_required,responsible_role,due_date
) values (
  '60000000-0000-4000-8000-000000000001',
  '10000000-0000-4000-8000-000000000001',
  'seller','needed',true,'spn',current_date+2
);

insert into public.nav_deal_risks_v2(
  id,deal_id,level,is_resolved,blocks_deposit,blocks_deal
) values (
