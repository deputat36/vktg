...
create or replace function harness.write_mapping_wave1(p_request_id uuid,p_plan jsonb)
returns jsonb
language plpgsql
...
begin
 ...
 m:=nav_v2_private.nav_v2_map_governed_intake_to_production_wave1_v1(p_plan);
 d:=m->'deal';
