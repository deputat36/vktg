...
revoke all on function public.nav_v2_get_deals_list(integer) from public, anon;
grant execute on function public.nav_v2_get_deals_list(integer) to authenticated, service_role;
