...
begin
  ...
  with frontend(function_name, source_label) as (
    values
      ...
      ('nav_v2_get_handoff_scores', 'deals handoff summary'),
      ...
      ('nav_v2_get_deal_status_options', 'deal-card status guard'),
      ('nav_v2_save_wizard_result', 'spn wizard'),
      ('nav_v2_update_deal_status', 'deal card'),
      ('nav_v2_update_document_status', 'deal-card document inline'),
      ('nav_v2_update_document_assignment', 'deal-card document assignment'),
      ('nav_v2_update_document_workflow', 'deal card'),
      ('nav_v2_update_task_status', 'deal card'),
      ('nav_v2_update_task_due_date', 'deal-card task due dates'),
      ...
      ('nav_v2_submit_spn_rework', 'deal card spn rework submit'),
