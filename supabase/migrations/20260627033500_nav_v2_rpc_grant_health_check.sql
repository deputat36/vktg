-- Admin-only diagnostic RPC for Navigator v2 function grants.
-- It lets the system check page detect missing authenticated EXECUTE grants
-- and accidental anon access before users hit broken screens.
...
revoke execute on function public.nav_v2_get_rpc_grant_health() from public;
