...
begin
  ...
  select coalesce(jsonb_agg(jsonb_build_object(
    ...
    'need_info_reviews_count', need_info_reviews_count,
    'blocked_reviews_count', blocked_reviews_count,
    'blocking_reviews_count', blocking_reviews_count,
    'latest_review_decision', latest_review_decision,
    'latest_reviewer_role', latest_reviewer_role,
    'latest_review_at', latest_review_at,
    'latest_review_body', latest_review_body,
    'latest_blocks_deposit', latest_blocks_deposit,
    'latest_blocks_deal', latest_blocks_deal,
    'buyer_spn', buyer_spn,
