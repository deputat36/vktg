...
def main() -> int:
    ...
    require(
        ...
        (
            ...
            "import { redactSensitiveFreeText }",
            "...clientDirectIdentifierKeys()",
            "FREE_TEXT_CONTEXT_KEYS",
            "sanitizeTextValue",
            "redactSensitiveFreeText(prepared)",
    ...
    require(
        ...
        (
            ...
            "legacy handoff identifiers must be removed or redacted",
            "output.deal.next_action",
            "output.tasks[0].description",
            "output.comments[0].body",
            "output.risks[0].description",
            "4 500 000 рублей",
            "18.07.2026",
        ),
        SEMANTIC.name,
