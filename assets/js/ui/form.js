...
export function getDeal() {
  return {
    ...
    representationModel: value('representationModel'),
    sellerRepresentation: value('sellerRepresentation'),
    buyerRepresentation: value('buyerRepresentation'),
    sellerPartnerName: value('sellerPartnerName'),
    buyerPartnerName: value('buyerPartnerName'),
    preparationOwner: value('preparationOwner'),
    documentsOwner: value('documentsOwner'),
    teamComment: value('teamComment'),
