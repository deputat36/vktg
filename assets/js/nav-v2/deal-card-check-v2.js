...
function draw() {
  app.innerHTML = `<main class="nav-v2-shell">
    ...
    <section class="card">
      <div class="status ok">Диагностика проверяет профиль, доступ, облегчённую карточку и полную карточку отдельно. Если полная карточка зависает, используйте безопасный вход.</div>
